...
const Banner = () => {
    return (
        <div className="lg:h-[554px] h-auto bg-[#1313130D] rounded-2xl flex items-center lg:justify-evenly flex-col-reverse lg:flex-row  gap-2 pt-4 lg:pr-0 lg:pt-0 shadow-xl">
