...
const RequestBookList = ({rlist}) => {

    const {bookId, bookName, image, author, tags, yearOfPublishing, publisher, totalPages, category, rating } = rlist;
    return (
...
RequestBookList.propTypes = {
    rlist: PropTypes.object
}
